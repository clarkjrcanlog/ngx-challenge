...
export class AuthService {
  ...
  getTaskList(){
    return this.http.get(`${this.connection}/user/taskList`).map(res => res.json());
  }

  saveTask(data) {
    return this.http.post(`${this.connection}/user/task`, data).map(res => res.json());
  }

  updateTask(id, data) {
    return this.http.put(`${this.connection}/user/updateTask/${id}`, data).map(res => res.json());
  }
